...
export const FhirMeasure_SupplementalData: t.Type<
  FhirMeasure_SupplementalData,
  FhirMeasure_SupplementalDataOutput
> = t.recursion('FhirMeasure_SupplementalData', () =>
  t.intersection([
    t.type({
      /** The Measure resource provides the definition of a quality measure. */
    ...
    t.partial({
      ...
      /** The Measure resource provides the definition of a quality measure. */
      usage: t.readonlyArray(FhirCodeableConcept),
    }),
  ])
)

/** The Measure resource provides the definition of a quality measure. */
export interface FhirMeasure_SupplementalData {
  /** The Measure resource provides the definition of a quality measure. */
  ...
  /** The Measure resource provides the definition of a quality measure. */
  usage?: ReadonlyArray<t.TypeOf<typeof FhirCodeableConcept>>
}
/** The Measure resource provides the definition of a quality measure. */
export interface FhirMeasure_SupplementalDataOutput {
  /** The Measure resource provides the definition of a quality measure. */
  ...
  /** The Measure resource provides the definition of a quality measure. */
  usage?: ReadonlyArray<t.OutputOf<typeof FhirCodeableConcept>>
}
