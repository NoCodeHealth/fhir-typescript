...
export const FhirTestScript_Destination: t.Type<
  FhirTestScript_Destination,
  FhirTestScript_DestinationOutput
> = t.recursion('FhirTestScript_Destination', () =>
  t.intersection([
    t.type({
      /** A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification. */
...
/** A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification. */
export interface FhirTestScript_Destination {
  /** A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification. */
...
/** A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification. */
export interface FhirTestScript_DestinationOutput {
  /** A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification. */
