...
export const FhirMolecularSequence_Outer: t.Type<
  FhirMolecularSequence_Outer,
  FhirMolecularSequence_OuterOutput
> = t.recursion('FhirMolecularSequence_Outer', () =>
  t.partial({
    /** Raw data describing a biological sequence. */
...
/** Raw data describing a biological sequence. */
export interface FhirMolecularSequence_Outer {
  /** Raw data describing a biological sequence. */
...
/** Raw data describing a biological sequence. */
export interface FhirMolecularSequence_OuterOutput {
  /** Raw data describing a biological sequence. */
