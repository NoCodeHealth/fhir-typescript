...
export const FhirTask_Input: t.Type<FhirTask_Input, FhirTask_InputOutput> = t.recursion('FhirTask_Input', () =>
  t.intersection([
    t.type({
      /** A task to be performed. */
...
/** A task to be performed. */
export interface FhirTask_Input {
  /** A task to be performed. */
...
/** A task to be performed. */
export interface FhirTask_InputOutput {
  /** A task to be performed. */
