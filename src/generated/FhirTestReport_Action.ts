...
export const FhirTestReport_Action: t.Type<FhirTestReport_Action, FhirTestReport_ActionOutput> = t.recursion(
  'FhirTestReport_Action',
  () =>
    t.partial({
      /** A summary of information based on the results of executing a TestScript. */
...
/** A summary of information based on the results of executing a TestScript. */
export interface FhirTestReport_Action {
  /** A summary of information based on the results of executing a TestScript. */
...
/** A summary of information based on the results of executing a TestScript. */
export interface FhirTestReport_ActionOutput {
  /** A summary of information based on the results of executing a TestScript. */
