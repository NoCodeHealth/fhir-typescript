...
export const FhirTestReport_Operation: t.Type<FhirTestReport_Operation, FhirTestReport_OperationOutput> = t.recursion(
  'FhirTestReport_Operation',
  () =>
    t.partial({
      /** A summary of information based on the results of executing a TestScript. */
...
/** A summary of information based on the results of executing a TestScript. */
export interface FhirTestReport_Operation {
  /** A summary of information based on the results of executing a TestScript. */
  ...
  /** A summary of information based on the results of executing a TestScript. */
  detail?: Readonly<t.TypeOf<typeof FhirUri>>
  /** A summary of information based on the results of executing a TestScript. */
...
/** A summary of information based on the results of executing a TestScript. */
export interface FhirTestReport_OperationOutput {
  /** A summary of information based on the results of executing a TestScript. */
  ...
  /** A summary of information based on the results of executing a TestScript. */
  detail?: Readonly<t.OutputOf<typeof FhirUri>>
  /** A summary of information based on the results of executing a TestScript. */
